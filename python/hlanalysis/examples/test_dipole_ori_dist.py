...
def main():
    ...
    # -----------------------------
    dipole_angles = orient_dist.dipole.cal_dipole_angles(water_map=water_mol_map,
    ...
    dipole_angles_bins_along_z = orient_dist.dipole.dipole_angle_bins_along_normal(
                                                     all_angles=dipole_angles,
                                                     bins_normal=z_edges,
    ...
    dipole_angles_avg_bins_along_z = orient_dist.dipole.accumulate_dipole_angle_bins_along_normal(
                                                    all_angles_bins=dipole_angles_bins_along_z,
                                                    centers_normal=z_centers,
                                                    bins_angles=angle_edges,
                                                    centers_angles=angle_centers
                                                    )
    dipole_angles_avg_bins_along_z = np.array(dipole_angles_avg_bins_along_z)
    ...
    output_data[:, 1:] = dipole_angles_avg_bins_along_z  
    np.savetxt(
        os.path.join(ori_result_dir, "dipole_bond_orient_dist.txt"),
        output_data,
        fmt="%.6f",
    ...
    # Visualization
    # ---------------------------------------------------------------------------------------------------------------- #
    dipole_angles_avg_bins_along_z /= num_frames
    dipole_angles_avg_prob_dist = dipole_angles_avg_bins_along_z / np.sum(dipole_angles_avg_bins_along_z)
    ...
    plot_angle_distribution(dipole_angles_avg_prob_dist, angle_centers, z_centers, save=True)
