...
use crate::utils::histogram::generate_bins::generate_dipole_angle_bins_along_normal;

use crate::analysis::orient_dist::compute_angles::compute_dipole_angles;


/// Compute Dipole moment angles relative to a given surface normal for each timestep.
///
/// Notes:
...
pub fn cal_dipole_angles(
...
) -> PyResult<Vec<Vec<(i32, i32, i32, f64)>>> {
    // Basic validation
    ...
    let all_angles:  Vec<Vec<(i32, i32, i32, f64)>> = files
        .par_iter()
...
#[pyfunction]
pub fn dipole_angle_bins_along_normal(
    all_angles: Vec<Vec<(i32, i32, i32, f64)>>,
    bins_normal: Vec<f64>,
    ...
    let all_angle_bins: Vec<Vec<Vec<f64>>> = files
        ...
        .filter_map(|((_, file_path), angles)| {
            ...
            Some(generate_dipole_angle_bins_along_normal(
                &atoms,
                angles,
                &bins_normal,
                &centers_normal,
...
#[pyfunction]
pub fn accumulate_dipole_angle_bins_along_normal(
